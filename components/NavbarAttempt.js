  ...
  return (
    <div className={style.container}>
      ...
      <li className={style.menuItem}>
        ...
        <DropdownMenu.Content className={style.content}>
          <DropdownMenu.Item className={style.text}><Link href="/products/mulching">Mulching</Link></DropdownMenu.Item><hr/>
          <DropdownMenu.Item className={style.text}><Link href="/products/residential-services">Residential Services</Link></DropdownMenu.Item><hr/>
          <DropdownMenu.Item className={style.text}><Link href="/products/commercial-services">Commercial Services</Link></DropdownMenu.Item><hr/>
          <DropdownMenu.Item className={style.text}><Link href="/products/excavation">Excavation</Link></DropdownMenu.Item>
          <DropdownMenu.Item className={style.text}><Link href="/products/waterscaping">Water Landscaping</Link></DropdownMenu.Item>
          <DropdownMenu.Item className={style.text}><Link href="/products/gardening">Gardening</Link></DropdownMenu.Item>
        </DropdownMenu.Content>
        </DropdownMenu.Root>
